...
--			}
--
--			local ColorUtil = require('plugins.utils.color')
--			local theme = {
--				normal = {
--					a = active,
--					b = active,
...
--						{
--							require('plugins.utils.lualine_util').plugin_title(),
...
--						-- stylua: ignore
--						{
--							require('plugins.utils.lualine_util').trails(),
--							cond = is_file_window,
--							padding = { left = 1, right = 0 },
...
--					lualine_y = {
--						{
--							require('plugins.utils.lualine_util').filemedia(),
--							padding = 1,
--							cond = function()
